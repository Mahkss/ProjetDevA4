...
public class EntityManager {
    ...
    static final String JDBC_URL = "jdbc:oracle:oci:schema_owner/1234@localhost:1521:orcl";  // NOT USED ANYMORE : redeclare in local method
    ...
    public EntityManager() {
        ...
        try
        {
            ...
            // Oracle SID = orcl
            connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "schema_owner", "1234");
