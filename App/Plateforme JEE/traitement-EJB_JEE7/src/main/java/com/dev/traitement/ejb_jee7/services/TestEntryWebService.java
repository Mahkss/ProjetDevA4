 ...
 * @author loicf
 */
@WebService(serviceName = "TestEntryWebService")
@Stateless()
public class TestEntryWebService {

    /**
     * This is a sample web service operation TEST
     */
    @WebMethod(operationName = "MainOperation")
    public void mainService() {
        ...
        DocumentAnalysisService docAnal = new DocumentAnalysisService(docName, document, key);
