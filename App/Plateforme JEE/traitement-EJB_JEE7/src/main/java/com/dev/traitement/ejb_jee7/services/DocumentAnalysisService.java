...
import com.dev.traitement.ejb_jee7.jms.MessageMDBSender;
...
public class DocumentAnalysisService {
    ...
    public void FindSecretWord() {
        ...
        MessageMDBSender mdb = new MessageMDBSender();
        try {
            mdb.sendJMSMessageToReceptionQueue(secretWord);
        } catch (JMSException ex) {
            Logger.getLogger(DocumentAnalysisService.class.getName()).log(Level.SEVERE, null, ex);
