...
public class MessageMDBReceptor implements MessageListener {  
    ...
    @JMSConnectionFactory("java:comp/jms/traitementConnection")
    private JMSContext context;
      
    public static void MessageReceptor() throws JMSException, NamingException { 
        Context context = new InitialContext();
      ConnectionFactory factory = (ConnectionFactory) context.lookup("jms/traitementConnection");
      Destination destination = (Destination) context.lookup("jms/traitementQueue");
